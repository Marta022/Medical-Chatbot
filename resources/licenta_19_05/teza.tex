...
\section{Datele indexate în Qdrant}
...
\phantomsection
\label{anexa:reasoning-retry-loop}
\lstinputlisting[language=Python]{codes/reasoning_retry_loop.py}
...
Ingestia în graf extrage entități și relații din fragmentele procesate, creează legăturile cu sursele originale și salvează în Kuzu reprezentarea structurată utilizată de regăsirea hibridă.
